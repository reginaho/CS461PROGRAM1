...
# Breadth-First Search (fixed to ensure correct traversal)
def bfs(graph, start, goal):
    ...
    while queue:
        ...
        if current_node == goal:
            return path  # Return the path immediately when goal is found
...
def main():
    ...
    while True:
        ...
        if method == "1":
            ...
            path = iddfs(graph, start, goal, max_depth=5)  # Adjust depth as needed
        elif method == "4":
